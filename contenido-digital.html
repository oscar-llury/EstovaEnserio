...
<html lang="es">
  ...
  <body class="bg-gray-200">
      ...
      <section class="py-5">
        <div class="container-fluid">
          <div class="grid">
            ...
            <!-- row 1 -->
            <div class="grid-item">
              <img src="./img/01-lio_studio.jpg" alt="" />
            </div>
            <div class="grid-item">
              <img src="./img/02-ochobajocero.png" alt="" />
            </div>
            <div class="grid-item">
              <img src="./img/03-bendita_burgers.png" alt="" />
            </div>
            <div class="grid-item">
              <img src="./img/04-arnau_griso.png" alt="" />
            </div>

            <!-- row 2 -->
            <div class="grid-item">
              <img src="./img/06-alexnader_som.png" alt="" />
            </div>
            <div class="grid-item">
              <img src="./img/05-grupo_lalala.jpg" alt="" />
            </div>
            <div class="grid-item">
              <img src="./img/09-botran.png" alt="" />
            </div>
            <div class="grid-item">
              <img src="./img/10-cefmx.png" alt="" />
            </div>
            <div class="grid-item">
              <img src="./img/07-fyvar.png" alt="" />
            </div>
            <div class="grid-item">
              <img src="./img/08-sons_of_ibiza.png" alt="" />
            </div>

            <!-- row 3 -->
            <div class="grid-item">
              <img src="./img/14-ifema.png" alt="" />
            </div>
            <div class="grid-item">
              <img src="./img/11-xcape.png" alt="" />
            </div>
            <div class="grid-item">
              <img src="./img/12-gala.png" alt="" />
            </div>

            <!-- row 4 -->
            <div class="grid-item">
              <img src="./img/13-noemi_misma.png" alt="" />
            </div>

            <div class="grid-item">
              <img src="./img/15-axa.png" alt="" />
            </div>
            <div class="grid-item">
              <img src="./img/16-jorge_leon.png" alt="" />
            </div>

            <!-- row 5 -->
            <div class="grid-item">
              <img src="./img/17-cuttoo.png" alt="" />
            </div>
            <div class="grid-item">
              <img src="./img/18-col_guatemala.png" alt="" />
            </div>
            <div class="grid-item">
              <img src="./img/19-gastronomia.png" alt="" />
            </div>
          </div>
        </div>
      </section>
    ...
    <script src="./node_modules/masonry-layout/dist/masonry.pkgd.min.js" type="text/javascript"></script>

    <script src="./node_modules/imagesloaded/imagesloaded.pkgd.min.js" type="text/javascript"></script>

    <script src="./assets/js/contenido-digital.js" type="text/javascript"></script>
  </body>
</html>
