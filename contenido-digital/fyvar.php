...
<head>
  <title>EstovaEnserio - FYVAR</title>
  ...
  <div class="blur shadow-blur">
    ...
    <div class="container-fluid img-header position-relative d-flex justify-content-center">
      <div class="main-title position-absolute container-lg">
        <h1 class="ms-4 ms-lg-0 mb-0">FYVAR</h1>
      </div>
        ...
        <div class="pb-4 container-lg">
          <div class="row">
            <div class="col-12 col-md-5 col-lg-4 col-info-proyecto pt-4">
              <p class="line-after h2">FYVAR</p>
              <h2 class="p">Cobertura de Fotografía y video corporativo de la feria FYVAR en IFEMA.</h2>
                ...
                <div class="accordion-item">
                  ...
                  <div id="sinopsisCollapse" class="accordion-collapse collapse" aria-labelledby="sinopsisHeader" data-bs-parent="#accordionDescripcion">
                    <div class="accordion-body">
                      <p class="m-0">FYVAR forma parte de EPPA, la Asociación Europea de Productos Promocionales. Esta asociación sin ánimo de lucro y registrada en Alemania, es una Organización aglutinadora de Asociaciones Europeas que se fundó en 1999.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-12 col-md-7 col-lg-8 order-first order-md-last pt-4 col-main-image">
              <img src="../img/contenido-digital/fyvar/01-portada-MKG6300.jpg" alt="FYVAR" title="FYVAR" class="w-100" />
            </div>
          </div>
          <div class="row mt-5">
                  ...
                  <ul class="splide__list">
                    <li class="splide__slide">
                      <div class="img_content openImg">
                        <img src="../img/contenido-digital/fyvar/02-09-scaled.jpg" alt='FYVAR' title='Ver imagen' />
                      </div>
                    </li>
                    <li class="splide__slide">
                      <div class="img_content openImg">
                        <img src="../img/contenido-digital/fyvar/03-DSC5190.jpg" alt='FYVAR' title='Ver imagen' />
                      </div>
                    </li>
                    <li class="splide__slide">
                      <div class="img_content openImg">
                        <img src="../img/contenido-digital/fyvar/04-MKG6382.jpg" alt='FYVAR' title='Ver imagen' />
                      </div>
                    </li>
                  </ul>
                </div>
