...
<head>
  <title>EstovaEnserio - GRUPO LALALA</title>
  ...
  <div class="blur shadow-blur">
    ...
    <div class="container-fluid img-header position-relative d-flex justify-content-center">
      <div class="main-title position-absolute container-lg">
        <h1 class="ms-4 ms-lg-0 mb-0">GRUPO LALALA</h1>
      </div>
        ...
        <div class="pb-4 container-lg">
          <div class="row">
            <div class="col-12 col-md-5 col-info-proyecto pt-4">
              <p class="line-after h2">GRUPO LALALA</p>
              <h2 class="p">Creación de contenido digital para grupo lalala. Fotografía y vídeo de producto, personal, clientes, inauguraciones, y mucho más.</h2>
                ...
                <div class="accordion-item">
                  ...
                  <div id="sinopsisCollapse" class="accordion-collapse collapse" aria-labelledby="sinopsisHeader" data-bs-parent="#accordionDescripcion">
                    <div class="accordion-body">
                      <p class="m-0">Grupo de restauración Madrileño. Grupo LALALA grupo de restauranción con 3 modelos de negocio restaurantes, cervecerias y salas de fiesta. En 2015 un equipo de jóvenes emprendedores como Luis Torremocha y Miguel Nicolás se lanzaron a la aventura de La Lianta, y 13 cervecerias, 10 restaurantes y 4 salas de fiesta después parece que no les ha ido nada mal.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-12 col-md-7 order-first order-md-last pt-4 col-main-image">
              <div class="main-video">
                <iframe src="https://player.vimeo.com/video/762331121?h=dba251252c&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen class='video-iframe'></iframe>
              </div>
            </div>
          </div>
          <div class="row mt-5">
              ...
              <section class="splide">
                <div class="splide__track">
                  <ul class="splide__list">
                    ...
                    <li class="splide__slide">
                      <div class="img_content openImg">
                        <img src="../img/contenido-digital/grupo-lalala/04-DSC04523.jpg" alt='Tortilla de patatas' title='Ver vídeo' data-type='video' data-src='https://player.vimeo.com/video/762331215?h=aff8485718&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479' />
                      </div>
                    </li>
                    <li class="splide__slide">
                      <div class="img_content openImg">
                        <img src="../img/contenido-digital/grupo-lalala/04-DSC04523.jpg" alt='GRUPO LALALA' title='Ver imagen' />
                      </div>
                    </li>
                    <li class="splide__slide">
                      <div class="img_content openImg">
                        <img src="../img/contenido-digital/grupo-lalala/04-DSC04523.jpg" alt='GRUPO LALALA DELIVERY' title='Ver vídeo' data-type='video' data-src='https://player.vimeo.com/video/762331252?h=cd82dc6a2b&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479' />
                      </div>
                    </li>
                    <li class="splide__slide">
                      <div class="img_content openImg">
                        <img src="../img/contenido-digital/grupo-lalala/04-DSC04523.jpg" alt='GRUPO LALALA - BURRATA' title='Ver vídeo' data-type='video' data-src='https://player.vimeo.com/video/762331278?h=2bba674826&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479' />
                      </div>
                    </li>
                  </ul>
                </div>
